...
<head>
    ...
    <title>LOGIN SATYA GRAHA WELLNESS CENTRE</title>
    ...
    <div class="container">
        ...
        <form class="form-signin" action="login-check.php" method="POST">
            <div class="form-signin-heading text-center">
                <img src="assets/images/login-logo2.png" alt="" style="width: 57%; height: auto;"/>
            </div>
            <div class="login-wrap">
                ...
                <button class="btn btn-lg btn-login btn-block" type="submit" style="background: #105ea0">
