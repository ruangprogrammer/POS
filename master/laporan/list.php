                    ...
                    <div class="adv-table editable-table ">
                        <div class="clearfix">
                            ...
                            <div class="btn-group pull-right">
                                <a href="<?php //echo SITE_HOST;?>http://localhost/POS_SATYA_GRAHA_WELLNESS_CENTRE/master/laporan/print.php" target="_blank">
                                ...
                                <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                    ...
                                    <tbody>
                                        ...
                                        while ($rowProduct = mysqli_fetch_array($resultProduct)) {
                                            ...
                                            echo $hasil;
                                            $subtotal = $rowProduct['product_harga'] * $hasil                                          ?> Jam
                                        </td>
                                      
                                        <td>
                                            Rp. <?php echo number_format($rowProduct['product_harga'], 0, ',', '.'); ?>
                                        </td>
