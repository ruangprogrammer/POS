...
error_reporting(0);
$id = $_GET['id'];
$queryRowCategory = mysqli_query($mysqli,"SELECT * FROM category where category_id = '" . $id . "'");
$rowCategory = mysqli_fetch_array($queryRowCategory);
if (isset($_POST['ubah'])) {
    $queryUpdate = mysqli_query($mysqli,"UPDATE category SET 
                        ...
                        <form class="cmxform form-horizontal adminex-form" id="commentForm" method="POST" action="">
                            <div class="form-group ">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    type="text" value="Nama Kategori<?php //echo $rowCategory['category_name'] ?>" required/>
                                </div>
                            </div>
                            <div class="form-group ">
