                ...
                <div class="adv-table editable-table ">
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        ...
                        <tbody>
                            <?php 
                            $no = 1;
                            $queryTransaksi = mysqli_query($mysqli,"SELECT *
                             FROM
                             `orders`
                             ORDER BY id_orders  DESC");
                            $total=0;
                            while ($rowTransaksi  = mysqli_fetch_array($queryTransaksi)) {
                                $sub_total=+$rowTransaksi['product_harga'] * $rowTransaksi['jumlah'];
                                ?>
                                <tr class="">
                                    <td><?php echo $no++; ?></td>
                                    ...
                                    <td style="text-align: right;">
                                        ...
                                        while($rowQueryTotal=mysqli_fetch_array($queryTotal)){
                                            ...
                                            $subTotal =+$rowQueryTotal['jumlah'] * $rowQueryTotal['product_harga'];
                                            $totalQuery +=$subTotal; 
                                        }
